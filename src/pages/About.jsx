...
export default function About() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-neutral-50 via-white to-purple-50/30 py-12 px-4 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        <div className="mb-8 animate-fadeIn">
          <h1 className="text-5xl md:text-6xl font-bold bg-gradient-to-r from-neutral-black via-purple-900 to-blue-900 bg-clip-text text-transparent mb-4">
        ...
        <div className="bg-white/80 backdrop-blur-xl rounded-[32px] shadow-[0_20px_70px_rgb(0,0,0,0.1)] border border-white/60 p-8 md:p-12 space-y-8 animate-slideInUp">
          ...
          <div>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              {[
                { icon: '🤖', title: 'Smart AI Matching', desc: 'Find perfect mentors using intelligent algorithms' },
                { icon: '📊', title: 'Progress Tracking', desc: 'Centralized dashboard for all mentorship activities' },
                { icon: '📅', title: 'Session Management', desc: 'Automated scheduling and session logs' },
                { icon: '📈', title: 'Analytics', desc: 'Performance insights and success metrics' }
              ].map((feature, index) => (
                <div key={index} className="group p-6 bg-gradient-to-br from-white to-purple-50/50 rounded-[24px] border border-purple-100/50 hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
          ...
          <div className="flex gap-4 pt-4">
            <Link 
              to="/" 
              className="inline-flex items-center gap-2 bg-gradient-to-r from-purple-600 to-blue-600 text-white px-8 py-4 rounded-[20px] font-bold shadow-[0_10px_30px_rgb(124,58,237,0.3)] hover:shadow-[0_15px_40px_rgb(124,58,237,0.4)] hover:-translate-y-0.5 transition-all duration-300"
            >
