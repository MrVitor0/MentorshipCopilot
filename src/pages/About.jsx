...
export default function About() {
  return (
    <>
      ...
      />
    <div className="min-h-screen bg-gradient-to-br from-neutral-50 via-white to-blue-50/20 py-12 px-4 relative overflow-hidden">
      {/* Decorative background elements */}
      <div className="absolute top-20 right-20 w-96 h-96 bg-gradient-to-br from-orange-200/20 to-blue-100/20 rounded-full blur-3xl"></div>
      <div className="absolute bottom-20 left-20 w-80 h-80 bg-gradient-to-br from-baires-blue-light/30 to-blue-300/20 rounded-full blur-3xl"></div>
      
      <div className="max-w-4xl mx-auto relative z-10">
        <div className="mb-8 animate-fadeIn">
          <h1 className="text-5xl md:text-6xl font-bold bg-gradient-to-r from-neutral-black via-baires-blue to-blue-700 bg-clip-text text-transparent mb-4">
        ...
        <div className="bg-white/80 backdrop-blur-xl rounded-[32px] shadow-[0_20px_70px_rgb(0,0,0,0.1)] border border-white/60 p-8 md:p-12 space-y-8 animate-slideInUp">
          ...
          <div>
            <h2 className="text-2xl font-bold text-neutral-black mb-6 flex items-center gap-3">
              ...
              Key Features
              <Sparkles className="w-5 h-5 text-baires-blue" />
            </h2>
            <div className="grid md:grid-cols-2 gap-4">
              {[
                { IconComponent: Bot, title: 'Smart AI Matching', desc: 'Find perfect mentors using intelligent algorithms', color: 'from-baires-blue to-blue-600' },
                ...
                <div key={index} className="group p-6 bg-gradient-to-br from-white to-blue-50/50 rounded-[24px] border border-orange-100/50 hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
                  ...
                  <h3 className="text-lg font-bold text-neutral-black mb-2 flex items-center gap-2">
                    {feature.title}
                    {index === 0 && <Sparkles className="w-4 h-4 text-baires-blue" />}
                  </h3>
          ...
          <div className="flex gap-4 pt-4">
            ...
            <Link 
              to="/dashboard" 
              className="inline-flex items-center gap-2 bg-gradient-to-r from-baires-blue to-blue-600 text-white px-8 py-4 rounded-[20px] font-bold shadow-[0_10px_30px_rgb(246,97,53,0.3)] hover:shadow-[0_15px_40px_rgb(246,97,53,0.4)] hover:-translate-y-0.5 transition-all duration-300"
            >
