...
export default function Register() {
  ...
  return (
    <>
      <SEO 
        title="Sign Up"
        description="Create your Mentorship CoPilot account"
      />
          ...
          <div className="bg-white rounded-[24px] shadow-xl border border-neutral-200/50 p-8">
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-white text-neutral-gray-dark font-medium">
                  or continue with
                </span>
              </div>
            </div>
            ...
            <button
              ...
              disabled={loading}
              className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white border-2 border-neutral-200 rounded-[14px] font-semibold text-neutral-black hover:bg-neutral-50 hover:border-neutral-300 transition-all disabled:opacity-50"
            >
            ...
            {/* Login Link */}
            <p className="mt-6 text-center text-sm text-neutral-gray-dark">
