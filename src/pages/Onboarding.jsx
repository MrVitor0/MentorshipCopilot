...
export default function Onboarding() {
  ...
  if (authLoading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-neutral-50 via-white to-blue-50/15">
        <div className="text-center">
          <div className="w-16 h-16 border-4 border-baires-blue border-t-transparent rounded-full animate-spin mx-auto mb-4"></div>
  ...
  const getTotalSteps = () => {
    if (formData.userType === 'mentee') return 3 // Bio, Type, Tech/Project
    if (formData.userType === 'pm') return 2 // Bio, Type (no tech)
    return 4 // Mentor: Bio, Type, Tech, Levels
  }
  ...
  const canProceed = () => {
    switch (step) {
      ...
      case 4:
        // Only mentors reach step 4 (tech levels)
        return formData.technologies.length > 0
      default:
        return true
    }
  ...
  return (
    <>
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-neutral-50 via-white to-blue-50/15 p-4">
        <div className="w-full max-w-2xl">
          ...
          <div className="mb-8">
            <div className="flex items-center justify-between mb-3">
              ...
              <span className="text-sm font-semibold text-baires-blue">
                {Math.round((step / totalSteps) * 100)}%
              </span>
            </div>
            <div className="h-2 bg-neutral-200 rounded-full overflow-hidden">
              <div 
                className="h-full bg-gradient-to-r from-baires-blue to-blue-600 transition-all duration-300 rounded-full"
          ...
          <div className="bg-white rounded-[24px] shadow-xl border border-neutral-200/50 p-8">
            ...
            {step === 2 && (
              <div className="space-y-6">
                <div className="text-center">
                  <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-blue-500 to-blue-600 rounded-[20px] shadow-lg mb-4">
                    ...
                    return (
                      <button
                        ...
                        className={`p-6 rounded-[20px] border-2 transition-all text-left ${
                          isSelected
                            ? 'border-baires-blue bg-orange-50 shadow-lg'
                      ...
                      >
                        <div className="flex items-start gap-4">
                          <div className={`w-12 h-12 rounded-[14px] flex items-center justify-center flex-shrink-0 ${
                            isSelected
                              ? 'bg-gradient-to-br from-baires-blue to-blue-600 text-white'
                          ...
                          <div className="flex-1">
                            <h3 className="font-bold text-neutral-black mb-1 flex items-center gap-2">
                              {type.label}
                              {isSelected && <Check className="w-5 h-5 text-baires-blue" />}
                            </h3>
            ...
            {/* Step 3: Technologies and Project (not for PMs) */}
            {step === 3 && formData.userType !== 'pm' && (
              <div className="space-y-6">
                <div className="text-center">
                  <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-baires-blue to-blue-600 rounded-[20px] shadow-lg mb-4">
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    <input
                      ...
                      className="flex-1 px-4 py-3 bg-neutral-50 border border-neutral-200 rounded-[14px] focus:outline-none focus:ring-2 focus:ring-baires-blue focus:border-transparent transition-all"
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2 p-4 bg-neutral-50 rounded-[14px] min-h-[80px]">
                      {formData.technologies.map((tech) => (
                        <div
                          key={tech}
                          className="group flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-baires-blue to-blue-600 text-white rounded-[10px] shadow-md"
                        >
            ...
            {/* Step 4: Tech Levels (only for mentors) */}
            {step === 4 && formData.userType === 'mentor' && (
              <div className="space-y-6">
                <div className="text-center">
                  <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-yellow-500 to-blue-600 rounded-[20px] shadow-lg mb-4">
                            ...
                            >
                              <Star
                                className={`w-6 h-6 transition-all ${
                                  level <= (formData.techLevels[tech] || 3)
                                    ? 'fill-baires-blue text-baires-blue'
                                    : 'text-neutral-300 group-hover:text-baires-blue'
                                }`}
                              />
                            </button>
                          ))}
