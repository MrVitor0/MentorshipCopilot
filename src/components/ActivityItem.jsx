...
export default function ActivityItem({ user, action, subject, badges = [], time, avatar }) {
  return (
    <div className="group flex gap-4 p-4 rounded-[18px] bg-gradient-to-r from-white to-neutral-50/50 hover:from-purple-50/30 hover:to-blue-50/30 border border-neutral-100 hover:border-purple-200/50 hover:shadow-md hover:-translate-y-0.5 transition-all duration-300 cursor-pointer">
