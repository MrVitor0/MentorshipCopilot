    ...
    <div className="space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            ...
            <div className="space-y-2">
              <div className="h-8 w-40 bg-neutral-300 rounded-lg"></div>
              <div className="h-4 w-48 bg-neutral-300 rounded-lg"></div>
            </div>
          </div>
          <div className="h-12 w-40 bg-neutral-300 rounded-[14px]"></div>
        </div>
      </Card>
        ...
        {[1, 2, 3, 4, 5, 6].map((i) => (
          <Card key={i} hover padding="md" className="group animate-pulse">
            <div className="flex flex-col h-full space-y-4">
              ...
              {/* Team Badge */}
              <div className="h-6 w-28 bg-neutral-300 rounded-full"></div>
      ...
      <div className="flex items-center justify-center py-8">
        <div className="flex items-center gap-3 bg-white px-6 py-3 rounded-[16px] shadow-lg border border-neutral-200">
          ...
          <span className="text-neutral-gray-dark font-medium">Loading projects...</span>
        </div>
      </div>
    </div>
  )
