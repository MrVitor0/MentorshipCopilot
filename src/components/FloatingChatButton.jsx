    ...
    <>
      ...
      >
        ...
        <div className="relative">
          ...
          <div className="absolute -inset-3 bg-gradient-to-r from-baires-indigo via-indigo-500 to-indigo-600 rounded-full opacity-60 blur-xl group-hover:opacity-90 animate-pulse transition-opacity duration-500"></div>
          
          {/* Middle Ring - 3D Effect */}
          <div className="absolute -inset-1 bg-gradient-to-br from-indigo-400 to-indigo-600 rounded-full opacity-40 group-hover:opacity-60 transition-opacity duration-300"></div>
          
          {/* Button Container with 3D Shadow */}
          <div className="relative w-16 h-16 bg-gradient-to-br from-baires-indigo via-indigo-500 to-indigo-600 rounded-full shadow-[0_10px_35px_rgb(79,70,229,0.5),0_4px_15px_rgb(0,0,0,0.15)] flex items-center justify-center transform transition-all duration-300 group-hover:scale-110 group-hover:shadow-[0_15px_50px_rgb(79,70,229,0.7),0_5px_20px_rgb(0,0,0,0.2)] group-hover:-translate-y-1 group-active:scale-95 group-active:translate-y-0">
            ...
            <div className={`absolute -top-1 -right-1 w-7 h-7 bg-white rounded-full flex items-center justify-center shadow-[0_4px_12px_rgba(0,0,0,0.15)] transition-all duration-300 ${isHovered ? 'scale-110 rotate-12' : 'scale-100 rotate-0'}`}>
              <Sparkles className="w-4 h-4 text-baires-indigo animate-pulse" />
            </div>
          ...
          {isHovered && (
            <div className="absolute inset-0 rounded-full border-2 border-baires-indigo animate-ping opacity-75"></div>
          )}
        </div>
