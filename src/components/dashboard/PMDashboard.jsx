import { Users, Target, Calendar, TrendingUp, Sparkles, FolderKanban, BarChart3, CheckCircle, Clock, Briefcase, ArrowRight, Search, Plus, Brain, Zap } from 'lucide-react'
            ...
            <Card gradient padding="xl" className="lg:col-span-2 relative overflow-hidden">
              ...
              <div className="relative">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div className="relative group">
                    <div className="absolute -top-3 -left-3 w-14 h-14 bg-gradient-to-br from-baires-indigo to-indigo-600 rounded-full flex items-center justify-center shadow-[0_10px_30px_rgb(79,70,229,0.3)] z-10 group-hover:scale-110 transition-transform duration-300">
                      <span className="text-white font-bold text-xl">2</span>
                    </div>
                    <div className="relative overflow-hidden bg-white p-6 pt-10 rounded-[24px] border-2 border-indigo-100 hover:border-indigo-300 hover:shadow-[0_20px_50px_rgb(79,70,229,0.15)] transition-all duration-300 h-full group-hover:-translate-y-1">
                      ...
                      <div className="relative">
                        <div className="w-16 h-16 bg-gradient-to-br from-baires-indigo to-indigo-600 rounded-[20px] flex items-center justify-center mb-5 shadow-lg group-hover:scale-110 group-hover:rotate-3 transition-all duration-300">
                        ...
                        <div className="inline-flex items-center gap-2 bg-indigo-50 text-baires-indigo px-3 py-1.5 rounded-full text-xs font-semibold">
