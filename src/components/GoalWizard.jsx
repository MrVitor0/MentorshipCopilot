...
export default function GoalWizard({ isOpen, onClose, onSubmit, initialGoals }) {
  ...
  const [goals, setGoals] = useState(initialGoals || DEFAULT_GOALS)
            ...
            <div className="space-y-6 animate-fadeIn">
              ...
              {(!goals || goals.length === 0) && (
                <div className="text-center py-12">
                  ...
                  <h4 className="text-lg font-bold text-neutral-black mb-2">No Goals Yet</h4>
            ...
            <div className="space-y-6 animate-fadeIn">
              <div className="p-4 bg-gradient-to-br from-green-50 to-green-100/50 rounded-[14px] border border-green-200">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-neutral-black mb-1">Goals Updated Successfully</p>
                    <p className="text-xs text-neutral-gray-dark leading-relaxed">
                      You have {goals?.length || 0} goal{(goals?.length || 0) !== 1 ? 's' : ''} configured. These will be displayed in your Progress Analytics section.
                    </p>
                  </div>
                </div>
              </div>
